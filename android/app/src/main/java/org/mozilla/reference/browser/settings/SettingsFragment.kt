...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private fun setupPreferences() {
        ...
        findPreference<Preference>("ani_search")?.apply {
            summary = org.mozilla.reference.browser.ani.BrowserPreferences.names[org.mozilla.reference.browser.ani.BrowserPreferences.index(requireContext())]
            setOnPreferenceClickListener {
                org.mozilla.reference.browser.ani.BrowserPreferences.chooseSearch(requireContext()) { setupPreferences() }
                true
            }
        }
