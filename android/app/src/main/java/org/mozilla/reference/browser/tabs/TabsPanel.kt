...
constructor(
    ...
    init {
        ...
        setTabTextColors(android.graphics.Color.parseColor("#9BA8BD"), android.graphics.Color.parseColor("#9AC5FF"))
        setSelectedTabIndicatorColor(android.graphics.Color.parseColor("#7DB4FF"))
        normalTab =
            newTab().apply {
